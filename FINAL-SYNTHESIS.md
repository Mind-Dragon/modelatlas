# Deerflow ModelDB — FINAL SYNTHESIS

Task hash: 001-deerflow-modeldb
Synthesis date: 2026-05-09
Sources: 7 domain files (OpenAI, Anthropic, Google, xAI+DeepSeek, Chinese Providers, Mistral+Aggregators, Others)

---

## PART A: DATABASE SCHEMA

PostgreSQL-compatible DDL with all constraints, foreign keys, indexes, and enum types.
...
### B4 — Model Capabilities (sample — representative subset)
...
### B5 — Model Pricing (representative subset — complete data for major providers)
...
| Provider | Data Source | Confidence | Last Verified | Refresh Cadence |
|----------|-------------|------------|---------------|-----------------|
| **OpenAI** | `openai.com/pricing`, `openai.com/api/pricing`, developer docs | High | 2026-05-09 | Weekly — OpenAI changes pricing monthly |
| **Anthropic** | `claude.com/pricing`, `platform.claude.com/docs` | High | 2026-05-09 | Weekly — pricing updates with new model releases |
| **Google** | `ai.google.dev/gemini-api/docs/pricing`, cloud pricing pages | High | 2026-05-09 | Monthly — stable pricing, tier thresholds change infrequently |
| **xAI** | xAI official docs, console.x.ai | Medium | 2026-05-09 | Weekly — rapid iteration, model retirement May 15, 2026 |
| **DeepSeek** | `api-docs.deepseek.com`, platform.deepseek.com | High | 2026-05-09 | Monthly — V4 Pro promo expires May 31, 2026 |
| **Alibaba** | Bailian official docs (CN), international pricing pages | Medium | 2026-05-09 | Monthly — CNY exchange rate dependent |
| **Zhipu** | `bigmodel.cn` pricing, Z.ai docs | Medium | 2026-05-09 | Monthly — CNY exchange rate dependent |
| **MiniMax** | minimax.io, minimaxi.com pricing | Medium | 2026-05-09 | Monthly — token plans and exchange rates |
| **Kimi/Moonshot** | `kimi.ai`, `moonshot.cn` docs | Medium | 2026-05-09 | Monthly — tier thresholds stable |
| **ByteDance** | Volcano Engine docs, `volcengine.com` | Medium | 2026-05-09 | Monthly — rapid iteration on Seed 2.0 |
| **Mistral** | `mistral.ai`, `docs.mistral.ai` | High | 2026-05-09 | Monthly — Mistral Small 3.2 deprecates Jul 31, 2026 |
| **OpenRouter** | `openrouter.ai/models` | High | 2026-05-09 | Continuous — model catalog changes daily |
| **Together AI** | `together.ai/pricing` | High | 2026-05-09 | Monthly — new models added frequently |
| **Fireworks AI** | `fireworks.ai/pricing` | High | 2026-05-09 | Monthly — competitive pricing adjustments |
| **Groq** | `groq.com/pricing` | High | 2026-05-09 | Monthly — limited model catalog, stable pricing |
| **Cohere** | `cohere.com/pricing` | Medium | 2026-05-09 | Quarterly — slow to change |
| **AI21** | `studio.ai21.com` | Medium | 2026-05-09 | Quarterly — legacy models stable |
| **Perplexity** | `docs.perplexity.ai` | High | 2026-05-09 | Monthly — Sonar API updates |
| **Meta Llama** | Partner pages (Groq, AWS, Together) | Medium | 2026-05-09 | Quarterly — no first-party API, model releases infrequent |
| **Azure** | `azure.microsoft.com/pricing` | High | 2026-05-09 | Monthly — regional pricing varies |
| **AWS Bedrock** | `aws.amazon.com/bedrock/pricing` | High | 2026-05-09 | Monthly — regional pricing varies |
| **Hugging Face** | `huggingface.co/pricing` | High | 2026-05-09 | Quarterly — stable tier structure |
| **Reka** | `platform.reka.ai` | Low | 2026-05-09 | Quarterly — limited public data |
| **Yi / 01.AI** | Partner platforms (Fireworks, OpenRouter) | Low | 2026-05-09 | Quarterly — limited first-party API |
| **Baichuan** | `platform.baichuan-ai.com` | Low | 2026-05-09 | Monthly — CNY exchange rate dependent |

### Data Points Requiring Periodic Refresh

1. **Promotional pricing**: DeepSeek V4 Pro 75% off promo (expires 2026-05-31), xAI Grok legacy retirements (2026-05-15), OpenAI DALL-E shutdown (2026-05-12)
2. **Exchange rates**: All CNY-priced providers (Alibaba, Zhipu, MiniMax, Kimi, ByteDance, Baichuan) — refresh monthly or when CNY/USD moves >5%
3. **Model sunset dates**: OpenAI o-series (2026-10-23), Anthropic legacy models, Mistral Small 3.2 (2026-07-31), DeepSeek V3 legacy (2026-07-24)
4. **Rate limit tiers**: Spend-based tier thresholds may change — check provider docs monthly
5. **New model releases**: All providers — check weekly for new model IDs and pricing
6. **Regional pricing**: AWS Bedrock and Azure regional pricing modifiers — check monthly

### Recommended Automation

- **Continuous**: OpenRouter API scrape (daily) — best single source for cross-provider pricing delta
- **Daily cron**: Check OpenAI, Anthropic, Google, xAI, DeepSeek pricing pages for changes
- **Weekly cron**: Check all Chinese provider pages, Mistral, aggregator pages
- **Monthly**: Full data refresh, update sunset dates, verify all endpoint URLs still resolve
- **Alert triggers**: Price change >10%, new model family release, sunset date within 30 days
  ...
  "rows": [
    {
      ...
      "description": "US AI research and deployment company — GPT, o-series, DALL-E, Whisper",
      "category": "us_ai_lab",
      "region": "us",
      "auth_type": "api_key",
      "status": "active"
    },
    {
      ...
      "description": "AI safety company — Claude model family",
      "category": "us_ai_lab",
      "region": "us",
      "auth_type": "api_key",
      "status": "active"
    },
    {
      ...
      "description": "Google Gemini API and Vertex AI platform",
      "category": "us_ai_lab",
      "region": "us",
      "auth_type": "api_key",
      "status": "active"
    },
    {
      ...
      "name": "xAI",
      "website": "https://x.ai",
      "description": "Elon Musks AI company — Grok model family",
      "category": "us_ai_lab",
      "region": "us",
      "auth_type": "api_key",
      "status": "active"
    },
    {
      ...
      "description": "Chinese AI lab — V4 Flash/Pro, R1",
      "category": "chinese_ai_lab",
      "region": "cn",
      "auth_type": "api_key",
      "status": "active"
    },
    {
      ...
      "description": "Bailian platform — Qwen model family",
      "category": "chinese_ai_lab",
      "region": "cn",
      "auth_type": "api_key",
      "status": "active"
    },
    {
      ...
      "description": "Zhipu / BigModel — GLM model family",
      "category": "chinese_ai_lab",
      "region": "cn",
      "auth_type": "api_key",
      "status": "active"
    },
    {
      ...
      "description": "Chinese AI startup — MiniMax M-series",
      "category": "chinese_ai_lab",
      "region": "cn",
      "auth_type": "api_key",
      "status": "active"
    },
    {
      ...
      "description": "Moonshot AI — Kimi K-series models",
      "category": "chinese_ai_lab",
      "region": "cn",
      "auth_type": "api_key",
      "status": "active"
    },
    {
      ...
      "description": "ByteDance Volcano Engine — Doubao / Seed models",
      "category": "chinese_ai_lab",
      "region": "cn",
      "auth_type": "api_key",
      "status": "active"
    },
    {
      ...
      "description": "French AI company — Mistral, Codestral, Pixtral",
      "category": "eu_ai_lab",
      "region": "eu",
      "auth_type": "api_key",
      "status": "active"
    },
    {
      ...
      "description": "Unified API gateway routing to 400+ models across 60+ providers",
    ...
    },
    {
      ...
      "description": "Open-source model inference and fine-tuning platform",
      "category": "api_aggregator",
      "region": "multi",
      "auth_type": "api_key",
      "status": "active"
    },
    {
      ...
      "description": "Fast inference platform — FlashAttention, quantization",
      "category": "api_aggregator",
      "region": "multi",
      "auth_type": "api_key",
      "status": "active"
    },
    {
      ...
      "description": "Ultra-fast LPU inference — open-source models only",
      "category": "api_aggregator",
      "region": "multi",
      "auth_type": "api_key",
      "status": "active"
    },
    {
      ...
      "description": "Enterprise AI — Command models, embeddings",
      "category": "us_ai_lab",
      "region": "us",
      "auth_type": "api_key",
      "status": "active"
    },
    {
      ...
      "description": "AI21 Labs — Jamba, Jurassic models",
      "category": "us_ai_lab",
      "region": "us",
      "auth_type": "api_key",
      "status": "active"
    },
    {
      ...
      "description": "AI search company — Sonar API",
      "category": "us_ai_lab",
      "region": "us",
      "auth_type": "api_key",
      "status": "active"
    },
    {
      ...
      "description": "Meta — Llama open-weight model family (no first-party API)",
    ...
    },
    {
      ...
      "description": "Azure OpenAI Service — GPT, o-series via Microsoft",
    ...
    },
    {
      ...
      "description": "Amazon Bedrock — multi-model managed service",
      "category": "cloud_platform",
      "region": "multi",
      "auth_type": "oauth",
      "status": "active"
    },
    {
      ...
      "description": "ML community platform — inference endpoints, model hub",
      "category": "api_aggregator",
      "region": "multi",
      "auth_type": "api_key",
      "status": "active"
    },
    {
      ...
      "description": "Multimodal AI — Core, Flash, Spark, Edge models",
      "category": "us_ai_lab",
      "region": "us",
      "auth_type": "api_key",
      "status": "active"
    },
    {
      ...
      "name": "01.AI",
      "website": "https://01.ai",
      "description": "Kai-Fu Lees company — Yi-Lightning, Yi-Large",
      "category": "chinese_ai_lab",
      "region": "cn",
      "auth_type": "api_key",
      "status": "active"
    },
    {
      ...
      "description": "Baichuan Intelligent Technology — Baichuan model family",
      "category": "chinese_ai_lab",
      "region": "cn",
      "auth_type": "api_key",
      "status": "active"
...
For production use, generate the following per-table JSON files:

| File | Description |
|------|-------------|
| `export/providers.json` | 25 providers with metadata |
| `export/provider_plans.json` | All plans per provider (120+ plans) |
| `export/models.json` | All models with specs (80+ models) |
| `export/model_capabilities.json` | Capability matrix per model |
| `export/model_pricing.json` | All pricing tiers per model per region |
| `export/endpoints.json` | All API endpoints (35+ endpoints) |
| `export/model_endpoint_map.json` | Model-to-endpoint routing |
| `export/model_aliases.json` | All model version aliases |

The JSON schema mirrors the SQL schema directly — each table becomes an array of objects with matching field names and types. Primary keys are embedded in objects (composite keys for join tables).
...
*End of FINAL-SYNTHESIS.md — task hash 001-deerflow-modeldb complete.*
*Generated: 2026-05-09 | Sources: 7 domain files | Schema: 8 tables, 25 providers, 80+ models*
